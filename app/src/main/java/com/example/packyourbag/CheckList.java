        ...
        switch (item.getItemId()){
            ...
            case R.id.btnDeleteDefault:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are you sure?\n\n As this will delete the data provied by (pack your bag) while instailling.")
            ...
            case R.id.btnReset:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are you sure?\n\nAs this will load the default data provied by ( pack your bag )"+
            ...
            case R.id.btnExit:
                this.finishAffinity();
                Toast.makeText(this,"Exit compleded",Toast.LENGTH_SHORT).show();
                return true;
       ...
       btnAdd.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
             ...
             if (itemName!= null && !itemName.isEmpty()){
                 addNewItem(itemName);
                 Toast.makeText(CheckList.this,"Iteam Added",Toast.LENGTH_SHORT).show();

             }else {
                 Toast.makeText(CheckList.this,"Empty cat be Added",Toast.LENGTH_SHORT).show();
             }
           }
       });
